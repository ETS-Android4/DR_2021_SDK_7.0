...
enum driveStyled
{
    FORWARD, BACKWARD, STRAFE_LEFT, STRAFE_RIGHT , STRAFE_LEFT_VEL, STRAFE_RIGHT_VEL, FORWARD_RIGHT, FORWARD_LEFT, BACKWARD_RIGHT, BACKWARD_LEFT, PIVOT_RIGHT, PIVOT_LEFT
}

public class CopyDemoBotDriveMecanum extends LinearOpMode
{
   ...
   public double[] setPower(double dirX, double dirY, double pivot)
    ...
    driveStyled - Desired direction the robot will drived. Uses enumeration declared at the top of the class
     ...
     */
    public boolean encoderDrive(int encoderDelta, driveStyled drive, double motorPower, DcMotorEx[] motors)
    {
        //ElapsedTime runtime = new ElapsedTime();

        //Comments in FORWARD also apply for all the other cases in this method

        //Switch statement used to handle which driveStyled enumeration was selected
        switch(drive)
        {
    ...
    public void timeDrive(long time, double motorPower, driveStyled drive, DcMotorEx[] motors)
    {
        switch(drive)
        {
            case FORWARD:
            ...
            case STRAFE_LEFT_VEL:
            {
                strafeLeftVel(motorPower, motors);
            ...
            case STRAFE_RIGHT_VEL:
            {
                strafeRightVel(motorPower, motors);
    ...
    public void OrientationDrive(double TargetOr, double motorPower, DcMotorEx[] motors, BNO055IMU imu) {
        Orientation angles;
    ...
    public void forward(double motorPower, DcMotorEx[] motors)
    {
    ...
    public void backward(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(0, motorPower, 0)[0]);
        motors[1].setPower(setPower(0, motorPower, 0)[1]);
        motors[2].setPower(setPower(0, motorPower, 0)[2]);
    ...
    public void strafeLeft(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(-motorPower, 0, 0)[0]);
        motors[1].setPower(setPower(-motorPower, 0, 0)[1]);
        motors[2].setPower(setPower(-motorPower, 0, 0)[2]);
    ...
    public void strafeRight(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(motorPower, 0, 0)[0]);
        motors[1].setPower(setPower(motorPower, 0, 0)[1]);
        motors[2].setPower(setPower(motorPower, 0, 0)[2]);
    ...
    public void strafeLeftVel(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setVelocity(setPower(-motorPower, 0, 0)[0]);
        motors[1].setVelocity(setPower(-motorPower, 0, 0)[1]);
        motors[2].setVelocity(setPower(-motorPower, 0, 0)[2]);
        motors[3].setVelocity(setPower(-motorPower, 0, 0)[3]);
    }
    public void strafeRightVel(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setVelocity(setPower(motorPower, 0, 0)[0]);
        motors[1].setVelocity(setPower(motorPower, 0, 0)[1]);
        motors[2].setVelocity(setPower(motorPower, 0, 0)[2]);
    ...
    public void forwardLeft(double motorPower, DcMotorEx[] motors)
    {
    ...
    public void forwardRight(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(motorPower, -motorPower, 0)[0]);
        motors[1].setPower(setPower(motorPower, -motorPower, 0)[1]);
        motors[2].setPower(setPower(motorPower, -motorPower, 0)[2]);
    ...
    public void backwardLeft(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(-motorPower, motorPower, 0)[0]);
        motors[1].setPower(setPower(-motorPower, motorPower, 0)[1]);
        motors[2].setPower(setPower(-motorPower, motorPower, 0)[2]);
    ...
    public void backwardRight(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(motorPower, motorPower, 0)[0]);
        motors[1].setPower(setPower(motorPower, motorPower, 0)[1]);
        motors[2].setPower(setPower(motorPower, motorPower, 0)[2]);
    ...
    public void pivotLeft(double motorPower, DcMotorEx[] motors)
    {
    ...
    public void pivotRight(double motorPower, DcMotorEx[] motors)
    {
        motors[0].setPower(setPower(0, 0, motorPower)[0]);
        motors[1].setPower(setPower(0, 0, motorPower)[1]);
        motors[2].setPower(setPower(0, 0, motorPower)[2]);
