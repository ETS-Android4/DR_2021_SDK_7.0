...
//            loopCount = 0;
    ...
    void pivot (int distanceL, int distanceR, double powerL, double powerR) {
        RobotHardware robot = new RobotHardware(hardwareMap);

        robot.motorRF.setTargetPosition(distanceR + robot.motorRF.getCurrentPosition());
        robot.motorRM.setTargetPosition(distanceR + robot.motorRM.getCurrentPosition());
        robot.motorRB.setTargetPosition(distanceR + robot.motorRB.getCurrentPosition());
        robot.motorLM.setTargetPosition(distanceL + robot.motorLM.getCurrentPosition());
        robot.motorLF.setTargetPosition(distanceL + robot.motorLF.getCurrentPosition());
        robot.motorLB.setTargetPosition(distanceL + robot.motorLB.getCurrentPosition());
