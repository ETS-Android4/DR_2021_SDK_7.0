...
@Autonomous(name="Gen2WarehouseRedCycle2")
//@Disabled

public class Gen2WarehouseRedCycle2 extends LinearOpMode
{
    BNO055IMU imu;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        encoderReadingRB = robot.motorRB.getCurrentPosition();
        ...
        robot.motorRF.setPower(.125);
        robot.motorRB.setPower(.125);
        robot.motorLB.setPower(.125);
        robot.motorLF.setPower(.125);
